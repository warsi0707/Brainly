...
export default function Card({title, link, type,content, time}) {
  return (
    ...
    <div className='max-w-72 ml-8 min-h-32 min-w-72 shadow-xl rounded-xl bg-white border-1 border-gray-200  p-3'>
        ...
        {type === 'twitter' &&
        <div className="content mt-5">
            <blockquote className="twitter-tweet h-40"><a href={link.replace('x.com', 'twitter.com')}></a></blockquote> 
        </div>}
        {/*Youtube*/}
        {type === 'youtube' &&
        <div className="content mt-5 ">
            ...
            <iframe width="250" height="315" src={link.replace('watch','embed')} title="YouTube video player" frameBorder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerPolicy="strict-origin-when-cross-origin" allowfullscreen></iframe>
