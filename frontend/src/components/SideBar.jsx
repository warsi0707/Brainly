      ...
      <div className="flex flex-col gap-10 ">
        ...
        <div className=" mt-10 ml-10 flex gap-2 ">
          {isLogin ? (
            ...
            <>
              <Link to={"/signin"}>
                <button className="bg-white py-2 px-3 rounded-md text-black hover:cursor-pointer hover:bg-gray-100 transition-all duration-300">
                  Login
                </button>{" "}
              </Link>
              <Link to={"/signup"}>
                <button className="bg-blue-600 py-2 px-3 rounded-md text-white hover:cursor-pointer hover:bg-blue-500 transition-all duration-300">
                  Join Now
                </button>
              </Link>{" "}
            </>
