    ...
    <div className='h-screen w-screen bg-gray-200 flex justify-center items-center'>
        <div className='bg-white min-w-72  rounded-xl p-3 '>
            <div className='mt-5 flex flex-col gap-5'> 
                ...
                <button onClick={Signup} className='bg-blue-500  py-1 rounded-md text-lg hover:bg-sky-600 text-white hover:cursor-pointer transition-all delay-150'>Signup</button>
            </div>  
        </div>
        {message &&
